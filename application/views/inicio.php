...
$color2 = array('#c8d5dc', '#1e88e5', '#7460ee', '#ffb22b', '#fc4b6c', '#99abb4');
?>
		                    ...
		                    <div class="col-md-3 col-lg-3">
		                        <div class="card">
		                            <div class="card-body" style="position: relative;">
		                                ...
		                                <h3 align="center" class="text-muted" style="left:50%; top: 60%; position: absolute; transform: translate(-50%, -50%); -webkit-transform: translate(-50%, -50%);">Resueltos <br><?php $porcent = $tipo_asociacion->result()[1]; echo ($porcent->cantidad/$porcent->total)."%";  ?></h3>
	                                    <div style="margin-left: 10px; margin-right: 10px;">
		                    ...
		                    <div class="col-md-3 col-lg-3">
		                        <div class="card">
		                            <div class="card-body" style="position: relative;">
		                                ...
		                                <h3 align="center" class="text-muted" style="left:50%; top: 60%; position: absolute; transform: translate(-50%, -50%); -webkit-transform: translate(-50%, -50%);">Comisionado <br><?php 

		                                		$texto = ""; if($sector_asociacion->num_rows() > 0){
        										foreach ($sector_asociacion->result() as $fila_sa) {
        											$texto .= $fila_sa->cantidad.substr($fila_sa->nombre, 0, 1)."/";
        										}
        									} echo substr($texto, 0, strlen($texto)-1);  ?></h3>
	                                    <div style="margin-left: 10px; margin-right: 10px;">
