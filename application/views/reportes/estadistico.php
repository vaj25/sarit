	...
	function mostrarReportePorPeriodo(tipo){
        ...
        if(anio!="" &&  (($("#mes").val()!="0" && document.getElementById('radio_mensual').checked==true)	
        	...
        	|| ($("#fecha_inicio").val()!="" && $("#fecha_fin").val()!="" && document.getElementById('radio_periodo').checked==true)
          	...
          	swal({ title: "¡Ups! Error", text: "Complete los campos.", type: "error", showConfirmButton: true });
        }
    }
    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="align-self-center" align="center">
                <h3 class="text-themecolor m-b-0 m-t-0">Informe de Actividades Reglamentos Internos de Trabajo</h3>
            </div>
        </div>
        <div class="row">
